 ...
 * climate.simulation.core.impl.HumidityCalculationEarth
 * 
 * @author shailesh
...
public class HumidityCalculationTest extends TestCase {
	...
	for (PlacesClimateBean placesClimateBean : placesClimateBeanList) {
	    assertNotNull(new Double(
		    humidityCalculation.generateRandomRelativeHumidity(
		            placesClimateBean.getAltitude(),
		            placesClimateBean.getLattitude(),
		            placesClimateBean.getLongitude(),
		            placesClimateBean.getTempreture())).intValue());
