 ...
 * The class is used to define methods methods for finding temperature and intensity of temperature by there months and hours 
...
public class TempretureCalculationEarth implements TempretureCalculation
{
	 ...
	 * Also initialization of credit weightage score for temperature intensity for day hours 
	 */
	static
	{
	 ...
	 *  there is a temperature relationship between latitude and altitude for more details  visit http://webinquiry.org/examples/temps/
		...
		For locations below 20N: Temperature = 80F.
		For locations between 20N and 60N: Temperature = -0.988 *(latitude) + 96.827F.
		
	 * @param lattitude 
	 * @param altitude 
	 *
	 * @return temperature
	 * @throws if latitude supplied is greter than 90 degree
	 */
